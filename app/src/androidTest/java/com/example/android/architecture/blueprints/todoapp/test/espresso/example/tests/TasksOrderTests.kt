...
class TasksOrderTests: BaseTest() {
    ...
    fun createTwoTasks() {
        todoListScreen = TodoListScreen()
                .clickOnFABButton()
                .addNewTask(taskItem1.title, taskItem1.description)
    ...
    fun activeTasksFilter() {
        todoListScreen
                ...
                .showActiveTasks()
                .checkIfTaskIsDisplayed(taskItem2.title)
                .checkIfTaskIsNotDisplayed(taskItem1.title)
    }
    ...
    fun completedTaskFilter() {
        todoListScreen
                .markTaskAsCompleted(taskItem1.title)
                .showCompletedTasks()
                .checkIfTaskIsDisplayed(taskItem1.title)
                .checkIfTaskIsNotDisplayed(taskItem2.title)
    }
